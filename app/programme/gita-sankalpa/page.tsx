...
export default function GitaSankalpaPage() {
  return (
    <ContentPage
      ...
      title="Gita Sankalpa"
      subtitle="The closing ceremony of the Bhagavad Gita Vishwa Mahotsav — a collective sacred vow to carry the Gita's wisdom into daily life."
      body={[
        "The Gita Sankalpa is the closing act of the Bhagavad Gita Vishwa Mahotsav — a solemn, joyful, collective moment in which every participant formally commits to living by the Bhagavad Gita's teachings.",
