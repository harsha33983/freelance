...
export default function GrandParayanaPage() {
  return (
    <ContentPage
      ...
      body={[
        "The Grand Gita Parayana is the centrepiece of the Bhagavad Gita Vishwa Mahotsav — a complete recitation of all 18 chapters of the Bhagavad Gita by the assembled gathering of 50,000+ participants.",
