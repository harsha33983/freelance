...
export default function CurtainRaiserProgrammePage() {
  return (
    <ContentPage
      ...
      subtitle="The inaugural event of the Bhagavad Gita Vishwa Mahotsav — launching across 18 countries simultaneously on Gita Jayanti."
      body={[
        ...
        "The programme includes: an inaugural address by the Patron and Spiritual Head, the ceremonial lighting of the Mahotsav Deepa, an inaugural cultural presentation, and the announcement of all 18 host countries and their chapter assignments.",
