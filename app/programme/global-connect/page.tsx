  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "The day culminates in a live global hookup of all 18 countries simultaneously — a few minutes of shared silence followed by a joint recitation of the Gita's final verse in Sanskrit.",
