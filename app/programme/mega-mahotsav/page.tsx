...
export const metadata: Metadata = { title: "Bhagavad Gita Vishwa Mahotsav — 27 February 2027" };
...
export default function MegaMahotsavPage() {
  return (
    <ContentPage
      ...
      body={[
        "The Bhagavad Gita Vishwa Mahotsav on 27 February 2027 is the culmination of eighteen months of preparation, pilgrimage, and practice. It is not merely a single day's event — it is the convergence of every stream of the global journey into one magnificent, unified expression.",
        ...
        "The Bhagavad Gita Vishwa Mahotsav closes at dusk with a grand procession, an illumination ceremony (deepotsava), and a cultural finale featuring performances by artists from all 18 participating countries.",
      ]}
      cta={{ label: "Register for Bhagavad Gita Vishwa Mahotsav", href: "/participate/register" }}
    />
  );
}
