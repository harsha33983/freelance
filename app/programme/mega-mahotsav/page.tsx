  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "The Mega Mahotsav closes at dusk with a grand procession, an illumination ceremony (deepotsava), and a cultural finale featuring performances by artists from all 18 participating countries.",
      ]}
