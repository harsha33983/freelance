  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "The programme includes: interactive discourse sessions led by young Gita teachers, a youth leadership panel featuring Gita-inspired practitioners from diverse fields, a creative arts showcase (spoken word, music, visual art) inspired by the Gita.",
