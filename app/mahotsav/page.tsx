  ...
  return (
    <>
      <PageHero
        ...
        subtitle="A landmark global spiritual celebration — bringing together 50,000+ seekers across 18 countries to honour the eternal wisdom of the Bhagavad Gita."
      />
