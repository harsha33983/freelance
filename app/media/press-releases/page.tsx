  ...
  return (
    <ContentPage badge="Press Releases" title="Press Releases"
      ...
      body={[
        ...
        "Press Release 1 (01 Sep 2026): Bhagavad Gita Vishwa Mahotsav Trust Formally Announces Bhagavad Gita Vishwa Mahotsav 2027 — The world's largest Bhagavad Gita celebration, spanning 18 countries, 18 chapters, and 18 languages, officially announced.",
        ...
        "Press Release 3 (15 Oct 2026): 18 Host Countries Confirmed — Full list of host countries announced, with chapter assignments for each country.",
