  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "Zone sponsorships provide naming rights for specific areas of the venue — the Youth Zone, the Gita Experience Zone, the Contemplative Garden, or the Cultural Pavilion.",
