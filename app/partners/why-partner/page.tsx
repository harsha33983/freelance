...
export default function WhyPartnerPage() {
  return (
    <ContentPage
      ...
      body={[
        "1. Unparalleled Reach: The Mahotsav will reach 50,000+ physical participants, 1 million+ virtual viewers, and communities across 18 countries. No other spiritual or cultural event offers this scale of positive, high-engagement audience.",
