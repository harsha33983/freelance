  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "In addition to these tiers, there are specific programme and zone sponsorships available — including sponsorship of the Grand Parayana, the Gita Jnana Sabha, the Cultural Programme, the Youth Zone, and the Gita Experience Zone.",
