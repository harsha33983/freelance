  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "The Jnana Pathway leads through discourse halls, the Gita Experience Centre, and scholarly exhibitions. The Karma Pathway leads through community service initiatives, the Global Partnership Pavilion, and institutional displays.",
