  ...
  return (
    <ContentPage
      ...
      body={[
        ...
        "In addition to physical attendees, the Mahotsav's virtual participation platform is expected to reach over 1 million simultaneous viewers on 27 February 2027, with the full event archive reaching many millions more.",
