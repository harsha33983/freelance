...
export default function AnnouncementBar() {
  const messages = [
    ...
    "27 FEBRUARY 2027 — BHAGAVAD GITA VISHWA MAHOTSAV",
  ...
  return (
    <div className="bg-[#D4AF37] text-white py-4 overflow-hidden relative z-50 flex">
      <div className="whitespace-nowrap animate-marquee inline-block flex-nowrap min-w-max">
        {repeated.map((msg, i) => (
